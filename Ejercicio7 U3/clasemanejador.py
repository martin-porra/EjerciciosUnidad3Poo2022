    ...
    def modificarBasico(self,cuil, nuevoBasico):
      ...
      while aux != None and not bandera:
          if aux.getdato().getcuil() == cuil:
              ...
              print('Se actualizo el sueldo basico')
              print(aux.getdato().getbasico())
          else:
              aux = aux.getsiguiente()
      if not bandera:
          print('No se encontro')                      
      ...
      while aux != None and not bandera:
          if aux.getdato().getcuil() == cuil:
              if isinstance(aux.getdato(),DocenteInvestigador):
                  ...
                  bandera = True
                  print('Se actualizo el extra {} '.format(aux.getdato().getextra()) )
              else:
                  print('No es investigador docente') 
                  bandera = True
          else:
              aux = aux.getsiguiente()
